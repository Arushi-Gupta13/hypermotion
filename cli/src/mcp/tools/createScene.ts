...
export const createSceneTool: Tool = {
  ...
  description:
    ...
    "Visual layers can include deformation: { kind: 'bend', enabled, angle, factor, showOriginalGeometry, bothDirections, limitToRegion, captureDirection: { x, y, z }, captureRotation, upDirection: { x, y, z }, upRotation, bendRotation, captureOrigin: { x, y, z }, captureLength, geometryDetail }. Angle is -360..360 degrees, factor is 0..1, captureLength 0 auto-fits the layer, and geometryDetail is 4..128. Bend angle, factor, directions, rotations, origin, and capture length can be keyframed with deformation.bend.* property IDs.\n" +
